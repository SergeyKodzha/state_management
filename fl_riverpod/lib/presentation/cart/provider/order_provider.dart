...
class OrderController extends StateNotifier<AsyncValue<Order?>>{
  ...
  void order() async {
    ...
    //state=await AsyncValue.guard(()=> _service.order());
  }
}

final orderProvider=StateNotifierProvider.autoDispose<OrderController,AsyncValue<Order?>>((ref) => OrderController(ref.read(storeServiceProvider)));