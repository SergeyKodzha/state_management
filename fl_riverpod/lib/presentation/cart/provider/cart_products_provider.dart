...
class CartProductsController extends StateNotifier<AsyncValue<Map<ProductID,Product>>>{
...
final cartProductsProvider=StateNotifierProvider.autoDispose<CartProductsController,AsyncValue<Map<ProductID,Product>>>((ref){
